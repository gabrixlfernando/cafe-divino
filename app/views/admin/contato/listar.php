    ...
    <tbody>
        <?php foreach ($contatos as $linha): ?>
            <tr>
                ...
                <td scope="col">
                    <?php
                    $mensagem = htmlspecialchars($linha['mens_contato'], ENT_QUOTES, 'UTF-8');
    ...
    function carregarContatos() {
        ...
        timeoutPesquisa = setTimeout(() => {
            ...
            `;
                    ...
                    <td title="${contato.mens_contato}">
                    ${contato.mens_contato.length > 50 ? contato.mens_contato.substring(0, 50) + '...' : contato.mens_contato}
                    </td>
